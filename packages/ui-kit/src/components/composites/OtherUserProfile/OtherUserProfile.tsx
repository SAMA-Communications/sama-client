  ...
  return (
    <WrapperRoot className={className} {...rest}>
      ...
      <div className="ui:relative ui:flex ui:flex-col ui:items-center ui:justify-center ui:gap-5 ui:rounded-[32px] ui:bg-accent-100 ui:py-10 ui:max-md:rounded-t-none">
        {actionButton != null ? (
          <div
            className="ui:absolute ui:top-8 ui:right-8 ui:max-md:top-8 ui:max-md:left-[4svw] ui:cursor-pointer"
            onClick={onAction}
          >
            {actionButton}
          </div>
          ...
          <button
            type="button"
            className="ui:absolute ui:top-8 ui:right-8 ui:max-md:top-8 ui:max-md:left-[4svw] ui:cursor-pointer ui:rounded-xl ui:bg-white ui:p-2 ui:shadow-btn"
            onClick={onAction}
