...
export const EditorValidationBar = ({
  ...
  return (
    <WrapperRoot className={clsx("ui:flex ui:items-end ui:gap-2.75", className)} {...rest}>
      <div className="ui:editor-validation ui:shadow-btn ui:flex ui:h-full ui:grow ui:items-center ui:justify-end ui:gap-2.75 ui:rounded-xl ui:bg-white ui:p-2">
        <div
          data-tooltip-id={tooltipId}
          data-tooltip-delay-hide={500}
          className="ui:flex ui:items-center ui:px-1"
        >
          {statusNode}
        </div>
      ...
      <button
        type="button"
        className="ui:bg-accent-500 ui:flex ui:h-11.5 ui:cursor-pointer ui:items-center ui:gap-1.75 ui:self-end ui:rounded-xl ui:border ui:p-2 ui:text-base ui:text-white"
        onClick={onCheck}
      >
