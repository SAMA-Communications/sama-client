...
describe("AvatarWithFallback", () => {
  ...
  it("renders provided fallback icon", () => {
    render(<AvatarWithFallback fallbackIcon={<span data-testid="custom-fallback">ICON</span>} />);
  ...
  it("renders img when avatarUrl loads successfully", async () => {
    ...
    render(<AvatarWithFallback avatarUrl="https://example.com/avatar.jpg" altText="User avatar" />);
