...
export default function SAMALogo({
  ...
  return (
    <m.div className={`${customClassName}`} variants={variants} initial={initial} animate={animate}>
      <svg
        className="w-full"
        id="Layer_1"
        data-name="Layer 1"
      ...
      .cls-4 {
        ...
        >
          ...
          <path className="cls-4" d="m248.66,153v-.06s0,0,0,.02c0,.02,0,.03,0,.04Z" />
          <path
            className="cls-4"
        ...
        >
          <path className="cls-1" d="m262.73,525.79s0,0,0,0c-.02-.01-.03-.02-.04-.03l.05.04Z" />
          <path
            className="cls-1"
